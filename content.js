...
exports.addModule('lib/orm/array');
exports.addModule('lib/orm/boolean');
exports.addModule('lib/orm/entry');
exports.addModule('lib/orm/field');
exports.addModule('lib/orm/list');
exports.addModule('lib/orm/millitime');
exports.addModule('lib/orm/map');
exports.addModule('lib/orm/number');
exports.addModule('lib/orm/object');
exports.addModule('lib/orm/parent');
exports.addModule('lib/orm/query');
exports.addModule('lib/orm/shard');
exports.addModule('lib/orm/text');
exports.addModule('lib/orm/wrap');
exports.addModule('lib/orm/wraps');
