 ...
 */
  ...
  if (slaves && (this._lid in slaves)) {
    delete slaves[this._lid];
//    console.log('REMOVED SHARD SLAVE', this.shard.identify(), this._lid);
  } else {
    M.log.error(Ose.error(this.shard, 'slaveNotRegistered', this._lid));
  }
