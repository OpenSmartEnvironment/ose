 ...
 */
  ...
  this.subjectState = O.subjectState.GONE;
 ...
 */
  ...
  if (this.subjectState !== O.subjectState.GONE) {
 ...
 */
  ...
  return this.subjectState === O.subjectState.GONE;
};
 ...
 */
  ...
  case O.subjectState.BUSY:
    ...
    return true;
  case O.subjectState.READY:
    this.subjectState = O.subjectState.BUSY;
    return cb(null, this);
  case O.subjectState.GONE:
 ...
 */
  ...
  case O.subjectState.INIT:
  case O.subjectState.BUSY:
    this.subjectState = O.subjectState.READY;
    this.emit('steady');
    return;
  case O.subjectState.READY:
    return;
...
exports.nextReady = function(cb) {  // {{{2
  ...
  case O.subjectState.READY:
    return O.async.nextTick(function() {
      if (that.subjectState === O.subjectState.READY) {
        return cb(null, that);
      }
