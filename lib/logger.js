 ...
 */
  ...
  case 3:
    ...
    this.log('error', message, {ident: err.ident, code: err.code, message: err.message, data: err.data});
    return err;
  }
 ...
 */
  ...
  if (c === count) {
    console.log('Suppressing following message, already logged', c, 'times');
  }
