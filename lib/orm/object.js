 ...
 *
 * @param wrap {Object} wrap of fields structure
 ...
 */
  ...
  if (patch === null) {
    for (var key in wrap.children) {
      ...
      child.field.iterPatch(child, null, val && val[key]);
    }
    return;
  }
  ...
  for (var key in patch) {
    ...
    if (child) {
      child.field.iterPatch(child, patch[key], val && val[key]);
    }
  }
  return;
};
