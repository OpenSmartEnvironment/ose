...
exports.iterLayout = function(wraps, layout, val, cb) {  // {{{2
/**
 ...
 * @param cb {Function(wrap)} Callback to be called on each new wrap
 *
 ...
 */
  ...
  return wraps.wrap(this, layout, val, undefined, cb);
};
...
exports.displayDetail = function(view, wrap) {  // {{{2
  var res = view.li().h3(this.displayName());

  var p = res.tree('p');

  /*
  if (! wrap.isReadonly()) {
    p.attr('contenteditable', undefined);
  }
  */
