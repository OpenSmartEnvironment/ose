...
exports.iterLayout = function(wraps, name, val, cb) {  // {{{2
/**
 * @copyMethod ose.lib.field.field|iterLayout
 */
  ...
  return wraps.wrap(this, name, val, children, cb);
};
