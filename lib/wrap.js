 ...
 * @readme
 *
 * This component facilitates the use of classes or singletons with
 ...
 */
  ...
  if (subject) {
    ...
    result.ident = this.identify(subject);
  }
  result._data = data;
...
//  console.log('WRAP CLASS', id);
  ...
  throw O.error(this, 'Module is not a class', id);
};
 ...
 *
 * @param [subject] Optional subject to be identified; if not
 * specified, the class identifies itself.
 *
 * @result {Object} Identification object
 *
 * @method identify
 */
