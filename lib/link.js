...
/**
 * Checks whether it is possible to substitute a pseudosocket with a
 * real socket.
 *
 * @param socket {Object} Pseudosocket to be checked
 *
 * @method canReplace
 * @internal
 */
...
/**
 * Checks whether it is possible to establish a link to `socket`.
 *
...
/**
 * Checks whether a socket is opened.
 *
...
/**
 * Checks whether a socket can be closed.
 *
 * @param socket {Object} Socket to be checked
 *
 * @method canClose
...
/**
 * Call to close a link with an error. This method invokes `error(err)` handler on socket at first. When link is connected, this method invokes `error(err)` handler on the other side.
 *
...
/**
 * Checks if a socket can be reused.
 *
 * @param socket {Object} Socket to be checked
 *
 * @method canReuse
